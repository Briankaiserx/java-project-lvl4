...
class AppTest {
    ...
    public static void beforeAll() throws IOException {
        ...
        String expected = Files.readString(Paths.get("src", "test", "resources", "mockweb"));
    ...
    @Test
    void testCheckUrl() {
        String mockDescription = "GitHub";
        String mockTitle = "new description";
        String mockH1 = "The world is mine";
